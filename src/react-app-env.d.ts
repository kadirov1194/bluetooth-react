...
declare class Bluetooth extends EventTarget {
  ...
  onadvertisementreceived:
    | ((this: Bluetooth, ev: BluetoothAdvertisingEvent) => any)
    | null;
...
declare class BluetoothDevice extends EventTarget {
  ...
  onadvertisementreceived:
    | ((this: BluetoothDevice, ev: BluetoothAdvertisingEvent) => any)
    | null;
...
declare class BluetoothRemoteGATTService extends EventTarget {
  ...
  oncharacteristicvaluechanged:
    | ((this: BluetoothRemoteGATTService, ev: Event) => any)
    | null;
  ...
  addEventListener<K extends keyof BluetoothRemoteGATTServiceEventMap>(
    ...
    listener: (
      ...
      ev: BluetoothRemoteGATTServiceEventMap[K]
    ) => any,
    options?: boolean | AddEventListenerOptions
  ): void;
  addEventListener(
...
declare class BluetoothRemoteGATTCharacteristic extends EventTarget {
  ...
  removeEventListener<
    K extends keyof BluetoothRemoteGATTCharacteristicEventMap
  >(
    type: K,
    listener: (
      this: BluetoothRemoteGATTCharacteristic,
...
interface CharacteristicEventHandlers {
  oncharacteristicvaluechanged: ((this: Bluetooth, ev: Event) => any) | null;
  addEventListener<K extends keyof CharacteristicEventHandlersEventMap>(
    type: K,
    listener: (
      this: Bluetooth,
      ev: CharacteristicEventHandlersEventMap[K]
    ) => any,
    options?: boolean | AddEventListenerOptions
  ): void;
  addEventListener(
  ...
  removeEventListener<K extends keyof CharacteristicEventHandlersEventMap>(
    type: K,
    listener: (
      this: Bluetooth,
      ev: CharacteristicEventHandlersEventMap[K]
...
interface BluetoothDeviceEventHandlers {
  ...
  ongattserverdisconnected: ((this: Bluetooth, ev: Event) => any) | null;
  addEventListener<K extends keyof BluetoothDeviceEventHandlersEventMap>(
    type: K,
    listener: (
      this: Bluetooth,
      ev: BluetoothDeviceEventHandlersEventMap[K]
    ) => any,
    options?: boolean | AddEventListenerOptions
  ): void;
  addEventListener(
  ...
  removeEventListener<K extends keyof BluetoothDeviceEventHandlersEventMap>(
    type: K,
    listener: (
      this: Bluetooth,
      ev: BluetoothDeviceEventHandlersEventMap[K]
...
interface ServiceEventHandlers {
  ...
  onservicechanged: ((this: Bluetooth, ev: Event) => any) | null;
  onserviceremoved: ((this: Bluetooth, ev: Event) => any) | null;
  addEventListener<K extends keyof ServiceEventHandlersEventMap>(
    type: K,
    listener: (this: Bluetooth, ev: ServiceEventHandlersEventMap[K]) => any,
    options?: boolean | AddEventListenerOptions
  ): void;
  addEventListener(
    type: string,
  ...
  removeEventListener<K extends keyof ServiceEventHandlersEventMap>(
    type: K,
    listener: (this: Bluetooth, ev: ServiceEventHandlersEventMap[K]) => any,
    options?: boolean | EventListenerOptions
  ): void;
